...
public class AlgoritmoDeDeteccionDeDesastres : MonoBehaviour
{
	...
	public string ire = " fire building outdoor street yellow smoke city light traffic fireplace"; //incendio en un edificio, residencia
	...
	public string animal = " animal attack reptile mammal outdoor grass"; // animal salvaje
	public string traf = "traffic stop signal, red, yellow, green, " +
		"sign city street light"; //semáforo descompuesto
	public string flood = " building, water, car, street, person, man, city, people, house";
	...
	void Check(string tagLeido)
	{
		...
		if (ifo.Contains(tagLeido))
		{
			...
			if (tagLeido.Equals("grass") || tagLeido.Equals("dark") || tagLeido.Equals("light") || tagLeido.Equals("nature")
				|| tagLeido.Equals("forest") || tagLeido.Equals("tree") || tagLeido.Equals("fire") ||
				tagLeido.Equals("smoke") || tagLeido.Equals("yellow"))
			{
				ifoN++;
			}
		}
		if (ire.Contains(tagLeido.ToString()))
		{
			...
			if (tagLeido.Equals("building") || tagLeido.Equals("smoke") || tagLeido.Equals("fire")
				|| tagLeido.Equals("street") || tagLeido.Equals("fireplace") || tagLeido.Equals("city")
				|| tagLeido.Equals("yellow"))
			{
				ireN++;
			}
		}
		...
		{
			if (tagLeido.Equals("surfing") || tagLeido.Equals("ocean") || tagLeido.Equals("wave") ||
				tagLeido.Equals("large"))
			{
				tsuN++;
			}
			tsuN++;
		...
		if (earth.Contains(tagLeido))
		{
			if (tagLeido.Equals("building") || tagLeido.Equals("street") || tagLeido.Equals("house")
				|| tagLeido.Equals("outdoor") || tagLeido.Equals("old"))
			{
				earthN++;
			}
			earthN++;
		...
		{
			autoN++;
			if (tagLeido.Equals("car") || tagLeido.Equals("truck") || tagLeido.Equals("street") ||
				tagLeido.Equals("old") || tagLeido.Equals("outdoor") || tagLeido.Equals("city"))
			{
				autoN++;
			}
		}
		...
		{
			animalN++;
			if (tagLeido.Equals("animal") || tagLeido.Equals("mammal") || tagLeido.Equals("outdoor") ||
				tagLeido.Equals("ground"))
			{
				animalN++;
			}
		}
		...
		{
			pheN++;
			if (tagLeido.Equals("laying") || tagLeido.Equals("lying") || tagLeido.Equals("person")
				|| tagLeido.Equals("man") || tagLeido.Equals("floor") || tagLeido.Equals("woman"))
			{
				pheN++;
			}
		}
		...
		{
			trafN++;
			if (tagLeido.Equals("traffic") || tagLeido.Equals("sign") ||
				tagLeido.Equals("red") || tagLeido.Equals("signal"))
			{
				trafN++;
			}
		}
