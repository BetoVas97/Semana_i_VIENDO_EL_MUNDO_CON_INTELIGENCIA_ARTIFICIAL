...
public class ImageToComputerVisionAPI : MonoBehaviour {
    ...
    string VISIONKEY = "fac106ed96ee468e9e94c84651de6934"; // replace with your Computer Vision API Key

    //string emotionURL = "https://westcentralus.api.cognitive.microsoft.com/vision/v1.0/analyze";
    string emotionURL = "https://southcentralus.api.cognitive.microsoft.com/vision/v1.0/analyze?visualFeatures=Categories,Description,Color&language=en";
    ...
    IEnumerator GetVisionDataFromImages()
    {
        ...
        PlayerPrefs.SetInt("enlaceActivator",1);
